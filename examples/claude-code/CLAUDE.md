# Odoo Skills — Claude Code

Add this to your existing `~/.claude/CLAUDE.md` or project-level `CLAUDE.md`.
...
1. **Load skills** from `~/.claude/skills/` — the `odoo-*` skills provide domain-specific rules.
...
Skills are installed at `~/.claude/skills/`. Each skill is a directory with a `SKILL.md` file. Load the relevant skill before writing any Odoo code.
<!-- END:odoo-skills -->
