# Odoo Skills Ecosystem — Claude Code

Add the section below to your `~/.claude/CLAUDE.md` (global) or project-level `CLAUDE.md`.
...
The master router `AGENTS.md` tells you which skill to load for each task. Skills are installed in `~/.claude/skills/` and loaded automatically based on context.
