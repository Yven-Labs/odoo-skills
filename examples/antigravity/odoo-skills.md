...
1. **Load skills** from `~/.gemini/skills/` — the `odoo-*` skills provide domain-specific rules.
...
Skills are installed at `~/.gemini/skills/`. Each skill is a directory with a `SKILL.md` file. Load the relevant skill before writing any Odoo code.
<!-- END:odoo-skills -->
