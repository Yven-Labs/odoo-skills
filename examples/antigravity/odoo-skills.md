# Odoo Skills Ecosystem — Antigravity

Add this to your Antigravity agent configuration or `~/.gemini/GEMINI.md`.
...
The master router `AGENTS.md` tells you which skill to load for each task. Skills are installed in `~/.gemini/antigravity/skills/` and loaded automatically based on context.
