# Odoo Skills Ecosystem — Codex

Add the section below to your `~/.codex/AGENTS.md`.
...
The master router `AGENTS.md` tells you which skill to load for each task. Skills are installed in `~/.codex/skills/` and loaded automatically based on context.
