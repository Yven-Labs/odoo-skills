# Odoo Skills Ecosystem — OpenCode

Add the section below to your `~/.config/opencode/AGENTS.md`.
...
The master router `AGENTS.md` tells you which skill to load for each task. Skills are installed in `~/.config/opencode/skills/` and loaded automatically based on context.
